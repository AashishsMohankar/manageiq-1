module ManageIQ::Providers
  class Inventory::Persister
    ...
    class Builder
      ...
      #
      # @example derives model_class from alibaba
      #
      #   @persister_class = ManageIQ::Providers::Alibaba::Inventory::Persister::CloudManager
      #   @name = :vms
      #
      #   returns - <provider_module>::<manager_module>::<@name.classify>
      #   returns - ::ManageIQ::Providers::Alibaba::CloudManager::Vm
      #
