class ManageIQ::Providers::CloudManager::Vm < ::Vm
  ...
  # Keeping floating_ip for backwards compatibility. Keeping association through vm_id foreign key, because of Alibaba
  # ecs, it allows to associate floating ips without network ports
