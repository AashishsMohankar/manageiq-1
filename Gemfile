...
group :alibaba, :manageiq_default do
  #manageiq_plugin "manageiq-providers-alibaba"
  gem 'manageiq-providers-alibaba', :path => '../manageiq-providers-alibaba'
  gem "amazon_ssa_support",                          :require => false, :git => "https://github.com/ManageIQ/amazon_ssa_support.git", :branch => "master" # Temporary dependency to be moved to manageiq-providers-alibaba when officially release
  gem "fog-aliyun",                                  :require => false, :git => "https://github.com/fog/fog-aliyun", :branch => "master"
end
