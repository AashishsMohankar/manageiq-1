describe VmOrTemplate do
  ...
  context "#resource_group" do
    before do
      ...
      @vm_with_rg     = FactoryBot.create(:vm_alibaba, :resource_group => @resource_group)
      @vm_without_rg  = FactoryBot.create(:vm_alibaba)
    end
  ...
  context "#supports_smartstate_analysis?" do
    ...
    it "returns false for Alibaba VM" do
      vm =  FactoryBot.create(:vm_alibaba)
