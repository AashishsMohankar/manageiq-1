describe MiqTemplate do
  ...
  it ".supports_kickstart_provisioning?" do
    expect(ManageIQ::Providers::Alibaba::CloudManager::Template.supports_kickstart_provisioning?).to be_falsey
  ...
  it "#supports_kickstart_provisioning?" do
    expect(ManageIQ::Providers::Alibaba::CloudManager::Template.new.supports_kickstart_provisioning?).to be_falsey
