FactoryBot.define do
  ...
  factory :ems_alibaba,
          :aliases => ["manageiq/providers/alibaba/cloud_manager"],
          :class   => "ManageIQ::Providers::Alibaba::CloudManager",
          :parent  => :ems_cloud do
    provider_region "us-east-1"
  end

  factory :ems_alibaba_network,
          :aliases => ["manageiq/providers/alibaba/network_manager"],
          :class   => "ManageIQ::Providers::Alibaba::NetworkManager",
          :parent  => :ems_network do
    provider_region "us-east-1"
  end

  factory :ems_alibaba_with_authentication,
          :parent => :ems_alibaba do
    authtype "default"
  end

  factory :ems_alibaba_with_cloud_networks,
          :parent => :ems_alibaba do
    after(:create) do |x|
      2.times { x.cloud_networks << FactoryBot.create(:cloud_network_alibaba) }
    end
  end
