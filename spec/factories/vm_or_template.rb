FactoryBot.define do
  ...
  factory :template_alibaba, :class => "ManageIQ::Providers::Alibaba::CloudManager::Template", :parent => :template_cloud do
  ...
  factory :vm_alibaba, :class => "ManageIQ::Providers::Alibaba::CloudManager::Vm", :parent => :vm_cloud do
    location { |x| "#{x.name}.us-west-1.compute.alibabaaliyun.com" }
    vendor   "alibaba"

    trait :with_provider do
      after(:create) do |x|
        FactoryBot.create(:ems_alibaba, :vms => [x])
      end
    end
