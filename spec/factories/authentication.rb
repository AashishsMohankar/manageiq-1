FactoryBot.define do
  ...
  factory :embedded_ansible_alibaba_credential,
          :parent => :embedded_ansible_credential,
          :class  => "ManageIQ::Providers::EmbeddedAnsible::AutomationManager::AlibabaCredential"
  ...
  factory :auth_key_pair_alibaba,    :class => "ManageIQ::Providers::Alibaba::CloudManager::AuthKeyPair"
